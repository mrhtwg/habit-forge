...
enum LanKey {
  ...
  dayClearAddFirstQuest, // 'Your day is clear. Add your first quest to start earning EXP and gold.'
  ...
  statVit, // 'VIT'
  statLuk, // 'LUK'
  statHelpHint, // 'Level-up points shape how you earn and survive.'
  statEffectStr, // 'Each point: +1% gold from tasks'
  statEffectInt, // 'Each point: +1% EXP from tasks'
  statEffectAgi, // 'Coming soon: streak protection'
  statEffectDef, // 'Each point: miss/skip costs 1 less HP (min 1)'
  statEffectVit, // 'Each point: +2 max HP'
  statEffectLuk, // 'Coming soon: better deals & gem luck'
  shopPermanent, // 'Town Shop'
  shopRandom, // 'Field Shop'
  rotationIn, // 'New picks in'
  ...
  completeQuestsEarnXpAndGold, // 'Complete quests, earn EXP and gold, and watch your hero grow every day.'
  ...
  finishTasksEarnXpAndGold, // 'Finish real tasks, earn EXP and gold, and watch your hero grow stronger every day.'
  ...
  notEnoughGems, // 'not_enough_gems'
  needMoreGold, // 'need_more_gold'
  needMoreGems, // 'need_more_gems'
