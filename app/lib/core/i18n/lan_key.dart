...
enum LanKey {
  ...
  playingLocally, // 'Playing on this device'
  signInOptional, // 'Sign In'
  premium, // 'Premium'
  premiumHeadline, // 'Level up your adventure'
  premiumSubtitle, // 'Unlock the full HabitForge experience'
  premiumPerkHabits, // 'Unlimited habit slots'
  premiumPerkClasses, // 'All hero classes'
  premiumPerkStats, // 'Month & all-time statistics'
  premiumPerkGear, // 'Legendary & exclusive gear'
  premiumPerkAds, // 'Ad-free play'
  planFree, // 'Free'
  planMonthly, // 'Premium Monthly'
  planYearly, // 'Premium Yearly'
  ...
  premiumGearLocked, // 'Premium exclusive gear'
  premiumStatsLocked, // 'Upgrade to see month & all-time stats'
  yearlyExclusive, // 'Yearly exclusive'
  legal, // 'Legal'
  ...
  tapToSignIn, // 'Tap below to sign in'
  ;
